...
1. `getPMbylatlon(latitude, longitude)`: similar to `getPMbyCityNames` but query by latitidue and longitude instead of a city name
...
Examples 1 and 2 use local dataset. Examples 3 would require active internet connection to access real-time data feed. 
...
The followings require active internet connection to access server for real-time feed. 
